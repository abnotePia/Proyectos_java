...
public class dd {
	...
	public static JFrame l=new JFrame();
	public static void main(String[] args) {
		...
		public void informacion(int cont) {
			...
			ImageIcon botonIco= new ImageIcon("./images/iniciar.png");
		...
		public  void elegirmodo(int numfilas,int numcol,int cont,int generaciones,String [][] taula,String [][] taula2) {
			...
			automatico.setBackground(Color.blue);
			automatico.setForeground(Color.red);
			n.add(manual);
			n.add(automatico);
			...
			automatico.addMouseListener(new MouseListener() {
				...
				public void mouseEntered(MouseEvent arg0) {
					// TODO Auto-generated method stub
					automatico.setBackground(Color.green);
				}
		...
		public void imprimir(int numfilas,int numcolumnas,String [][] taula2,String[][]taula,final int generaciones) {
				...
				Timer timer = new Timer (800, new ActionListener ()
				{
				    ...
				    {	
						...
						establecercolorcelula(numfilas,numcolumnas,pantalla,taula2,nuevo);
		...
		public void establecercolorcelula(int numfilas,int numcolumnas,JLabel [][] pantalla,String [][]taula2, JPanel contenedor) {
			for (int fil=0;fil<numfilas;fil++) {
				for (int colu=0;colu<numcolumnas;colu++) {
					...
					contenedor.add(pantalla[fil][colu]);
				}
			}
		}
